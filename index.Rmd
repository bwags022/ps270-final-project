...
For this milestone, I will show the top 10 medal winning countries medals sorted by Summer and Winter Olympics. The top ten countries are the United States (USA), the Soviet Union (URS), Great Britain (GBR), France (FRA), China (CHN), Germany (GER), Italy (ITA), Australia (AUS), Japan (JPN), Hungary (HUN). First I will add an indicator to separate Summer and Winter Games.
